...
const formatDateForInput = (dateString: string | null): string => {
  if (!dateString) return '01 Jan 2000';

  // Convertir cualquier formato a DD MMM YYYY para Litepicker
  return dayjs(dateString).format('DD MMM YYYY');
};

const formatDateForInputSpanish = (dateString: string | null): string => {
  if (!dateString) return '';

  // Convertir cualquier formato a DD MM YYYY para Litepicker
