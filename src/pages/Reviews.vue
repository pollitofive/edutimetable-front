    ...
    <div class="col-span-12">
      <div class="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
        ...
        <div class="flex flex-col sm:flex-row gap-x-3 gap-y-2 md:ml-auto">
          ...
          >
            <Lucide icon="ShieldOff" class="stroke-[1.3] w-4 h-4 mr-2" />
            Flag Review
          </Button>
        </div>
      </div>
        ...
        <div class="flex flex-col box box--stacked">
              ...
              <Popover class="inline-block" v-slot="{ close }">
                ...
                <Popover.Panel placement="bottom-end">
                  <div class="p-2">
                    ...
                    <div class="mt-3">
                      <div class="text-left text-slate-500">Review Rate</div>
          ...
          <div class="overflow-auto xl:overflow-visible">
            <Table class="border-b border-slate-200/60">
              ...
              <Table.Tbody>
                <template
                  v-for="(faker, fakerKey) in _.take(reviews.fakeReviews(), 10)"
                  :key="fakerKey"
                >
                  <Table.Tr class="[&_td]:last:border-b-0">
                    ...
                    <Table.Td class="py-4 border-dashed dark:bg-darkmode-600">
                      <div class="italic leading-relaxed truncate w-72">
                        "{{ faker.comment }}"
                      </div>
                    </Table.Td>
                    <Table.Td
