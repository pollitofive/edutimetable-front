          ...
          <div class="flex flex-col gap-6 px-5">
            <div>
              ...
              <div class="grid grid-cols-12 gap-3 sm:gap-3.5">
                <template
                  v-for="(faker, fakerKey) in _.take(files.fakeFiles(), 6)"
                  :key="fakerKey"
                >
                  <div
                  ...
                  >
                    <div
                      class="relative px-3 pt-8 pb-5 rounded-[0.6rem] border border-slate-200/80 hover:bg-slate-50 cursor-pointer transition sm:px-5 shadow-sm dark:hover:bg-darkmode-400"
                    >
                      ...
                      <template v-else-if="faker.type == 'Folder'">
                        <FileIcon class="w-2/4 mx-auto" variant="directory" />
                      </template>
                      ...
                      <a
                        href=""
                        class="block mt-4 font-medium text-center capitalize truncate"
                      >
                        {{
