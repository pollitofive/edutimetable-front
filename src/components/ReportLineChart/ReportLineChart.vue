...
const getSecondaryBackground = () => {
  ...
  gradient?.addColorStop(
    0,
    darkMode.value ? "#28344e00" : getColor("slate.50")
  );
  gradient?.addColorStop(1, darkMode.value ? "#28344e00" : "#ffffff01");
  return gradient;
};
  ...
  const data = [
    [
      ...
      [
        ...
        -13, -18, -17, -22, -27, -21, -51, -56, -50, -25, -55, -30, -5, 20, 45,
        70, 69, 94, 119, 118, 124, 94, 100, 99, 98, 68, 74, 80, 86, 111, 110,
        80, 86, 111, 106, 112, 107, 108, 109, 104, 99, 105, 100, 70, 71, 66, 61,
        67, 37, 32, 27, 33, 28, -2, 4, 10, 5, 0,
      ],
    ],
    [
      [
      ...
      [
        ...
        31, 56, 26, 51, 50, 75, 100, 125, 131, 137, 107, 77, 83, 53, 54, 60, 61,
        62, 63, 33, 39, 9, 4, 10, 16, 22, 28, -2, 4, 10, 5, 0,
      ],
    ],
    [
      [
    ...
    [
      [
        ...
        -16, -46, -40, -41, -35, -29, -4, -34, -9, -39, -14, 11, 36, 42, 41, 47,
        72, 97, 122, 147, 172, 197, 198, 193, 188, 158, 159, 165, 171, 177, 172,
        142, 137, 107, 77, 72, 78, 73, 68, 63, 33, 34, 4, 10, 5, 0,
      ],
      [
    ...
    datasets: [
      {
        ...
        borderWidth: 1.1,
        borderColor: colorScheme.value ? props.borderColor() : "",
        pointRadius: 0,
      ...
      },
      {
        ...
        borderWidth: 1.1,
        borderColor: colorScheme.value ? getColor("slate.400") : "",
        pointRadius: 0,
        borderDash: [1, 1],
