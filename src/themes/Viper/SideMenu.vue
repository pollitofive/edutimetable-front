...
<template>
  ...
  >
    ...
    >
      <div
        class="fixed top-0 inset-x-0 z-10 h-[65px] box bg-slate-50 border-x-0 border-t-0 rounded-none flex shadow-none"
      >
        <div
          :class="[
        ...
        >
          <div class="flex items-center w-full h-full px-5">
            ...
            >
              <div
                class="bg-slate-100 border w-[350px] flex items-center py-2 px-3.5 rounded-[0.5rem] text-slate-400 cursor-pointer hover:bg-slate-50 transition-colors dark:bg-black/20"
              >
                <Lucide icon="Search" class="w-[18px] h-[18px]" />
