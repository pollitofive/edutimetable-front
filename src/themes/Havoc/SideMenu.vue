...
<template>
  ...
  >
    ...
    >
      <div
        class="fixed top-0 inset-x-0 z-10 h-[65px] bg-gradient-to-r from-theme-1 to-theme-2 shadow-lg flex"
      >
        <div
          :class="[
        ...
        >
          <a
            href=""
            class="hidden xl:flex items-center transition-[margin] group-[.side-menu--collapsed]:xl:ml-8 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0"
          >
            <div
          ...
          <a
            ...
            class="hidden group-[.side-menu--collapsed.side-menu--on-hover]:xl:opacity-100 group-[.side-menu--collapsed]:xl:rotate-180 group-[.side-menu--collapsed]:xl:opacity-0 transition-[opacity,transform] 3xl:flex items-center justify-center w-[20px] h-[20px] ml-auto text-white border rounded-full border-white/40 hover:bg-white/5"
          >
        ...
        <div
          class="absolute transition-[padding] duration-100 xl:pl-[275px] group-[.side-menu--collapsed]:xl:pl-[91px] ml-5 h-full inset-x-0"
        >
      ...
      <div
        class="absolute inset-y-0 xl:top-[65px] xl:py-3.5 z-10 xl:z-0"
        @mouseover="
          (event) => {
            event.preventDefault();
            compactMenuOnHover = true;
